...
export interface OrdemParanormalDicesFormulas extends DicesFormulas {
   d3: Dice;
   d4: Dice;
   d6: Dice;
   d10: Dice;
...
const ordemParanormalDicesFormula: OrdemParanormalDicesFormulas = {
...
export class OrdemParanormalDices implements Dices {
   dicesFormulas: OrdemParanormalDicesFormulas = ordemParanormalDicesFormula;
